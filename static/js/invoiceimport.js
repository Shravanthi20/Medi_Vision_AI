...
document.addEventListener('DOMContentLoaded', () => {
    ...
    choiceInput.addEventListener('input', (e) => {
        ...
        if (val && (val < '1' || val > '3')) {
            ...
            feedbackText.textContent = 'Invalid choice. Please enter 1-3.';
        } else {
            feedbackText.style.color = '#60a5fa';
            feedbackText.textContent = 'Enter Choice 1-3';
        }
    });
    ...
    choiceInput.addEventListener('keypress', (e) => {
        if (e.key === 'Enter') {
            ...
            if (val >= '1' && val <= '3') {
                handleAction('Import Option ' + val);
            }
        }
    });
